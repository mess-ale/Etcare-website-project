            ...
            <div class="space-y-4">
                ...
                <div class="flex space-x-3">
                    ...
                    <nuxt-link to="https://www.youtube.com/@etcarebeautyandcosmeticssales" target="_blank">
                        <svg class="socialM text-primary" xmlns="http://www.w3.org/2000/svg" width="2em" height="2em"
                            viewBox="0 0 24 24">
                            <path fill="currentColor"
                    ...
                    <nuxt-link to="https://vm.tiktok.com/ZMhQxWYC7/" target="_blank"> <svg class="socialM text-primary"
