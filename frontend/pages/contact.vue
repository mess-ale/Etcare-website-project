<template>
    <div>
        ...
        <div class="">
            <div class="body-padding_margin grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="space-y-8 mb-10">
                    <div class="space-y-2">
                        <h1 class="font-oswald xxxs:text-3xl md:text-4xl font-bold text-secondary">ADDRESS</h1>
                    ...
                    <div class="space-y-2">
                        <h1 class="font-oswald  xxxs:text-3xl md:text-4xl  font-bold text-secondary">WORKING HOURS</h1>
                        <div class="flex items-center space-x-4 text-secondary font-robot">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
                                <path fill="currentColor"
                    ...
                    <div class="space-y-2">
                        <h1 class="font-oswald  xxxs:text-3xl md:text-4xl  font-bold text-secondary">FOLLOW US</h1>
                        <div class="flex space-x-3">
                            ...
                            <nuxt-link to="https://t.me/etcaresacco" target="_blank"><svg class="socialM text-primary"
