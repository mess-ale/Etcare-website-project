            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="">
                    <div class="saving-right-box">
                        <!-- Section Header -->
                        <h1 class="text-primary font-oswald text-2xl text-center font-bold xxxs:p-2 md:p-4">Why Save with Us?</h1>
                ...
                <div>
                    <ul>
                        ...
                        <li>Standard Savings, Interest Savings, Time Limit Savings, as defined in the
                            Cooperative's Articles of Association Interest Free Savings, Child Savings and Home Savings,
                    ...
                    <ul>
                        ...
                        <li>The deposit period is six months and the interest rate for six months is 8-12 per month The
                            amount and duration will depend. The deposit amount is more than five hundred thousand birr
                            If
