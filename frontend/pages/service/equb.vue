<template>
    <div class="text-primary pb-8">
        ...
        <div id="equb" class="body-padding_margin duration-500 flex gap-4">
                    ...
                    <div class="saving-right-box">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex gap-4 p-4 border-b border-gray-200">
                                ...
                                <p class="text-primary text-justify">
                                    Earn competitive interest rates on your savings, helping you grow your funds over
                                    time.
                                </p>
                            </div>
                ...
                <div class="">
                    ...
                    <ul>
                        ...
                        <li>The cooperative can encourage time saving It will be only when it is confirmed that the
                            ...
                            to
                            use it is high.</li>
                        <li> Time limit savings for loan guarantee until the guarantee is lifted as a cost to the member
                            not
                            paid
                        </li>
                    </ul>
                    ...
                    <ul>
                        ...
                        <li>The member can spend the savings without considering the interest, the money as a guarantee
                            Only
                            if
                            not caught.</li>
                    </ul>
                    ...
                    <ul>
                        ...
                        <li>The children of the members of the cooperative who are under 18 years of age Children you
                            manage
                        ...
                        <li>Children who have been saving in the cooperative and reached the age of 18 If you meet the
                            other
                    ...
                    <ul>
                        ...
                        <li>In order to encourage women to become entrepreneurs, it has become necessary to initiate a
                            form
                            of
                            savings.</li>
