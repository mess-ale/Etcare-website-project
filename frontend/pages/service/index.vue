<template>
    <div>
        ...
        <div class="xxxs:py-6 md:py-12">
            <div class="body-padding_margin space-y-4 pb-6">
                <h1
                    class="text-center text-primary font-oswald font-bold xxxs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl">
                    Etcare SACCO Services</h1>
                <p class="text-center text-primary font-light font-oswald xxxs:text-base sm:text-lg lg:text-xl">Our services include Savings, Loans,
                    Micro Insurance, and the digital Equb system, all designed to meet your specific needs and help you
        ...
        <div class="xxxs:py-6 md:py-12">
            <div class="body-padding_margin grid grid-cols-1 md:grid-cols-2 gap-0 service-body">
                ...
                <div :class="{ 'onscreenright': isVisibleright1 }" class="offscreenright" ref="myElementright1">
                    <div class="space-y-4 p-4">
                        <h1 class="text-secondary font-oswald xxxs:text-3xl md:text-5xl font-bold">Saving</h1>
                        <p class="text-primary font-robot text-xl text-justify xxxs:text-base sm:text-lg lg:text-xl">We understand the importance of saving
                            for
                            the future, which is why we offer convenient and flexible savings options to help our
                            members
                            build financial security. Whether it's short-term goals or long-term planning, our savings
                            accounts provide a safe and reliable way to grow your money.</p>
                        <div class="flex">
                            <nuxt-link class="service-button items-center text-xl font-oswald flex space-x-4 font-robot"
                                to="/service/saving">
                ...
                <div :class="{ 'onscreenleft': isVisibleleft2 }" class="offscreenleft" ref="myElementleft2">
                    <div class="space-y-4 p-4">
                        <h1 class="text-secondary font-oswald xxxs:text-3xl md:text-5xl font-bold">Training</h1>
                        <p class="text-primary font-robot text-xl text-justify xxxs:text-base sm:text-lg lg:text-xl">We understand the importance of saving
                            for
                            the future, which is why we offer convenient and flexible savings options to help our
                            members
                ...
                <div :class="{ 'onscreenright': isVisibleright3 }" class="offscreenright" ref="myElementright3">
                    <div class="space-y-4 p-4">
                        <h1 class="text-secondary font-oswald xxxs:text-3xl md:text-5xl font-bold">Equb</h1>
                        <p class="text-primary font-robot text-xl text-justify xxxs:text-base sm:text-lg lg:text-xl">We understand the importance of saving
                            for
                            the future, which is why we offer convenient and flexible savings options to help our
                            members
                ...
                <div :class="{ 'onscreenleft': isVisibleleft4 }" class="offscreenleft" ref="myElementleft4">
                    <div class="space-y-4 p-4">
                        <h1 class="text-secondary font-oswald xxxs:text-3xl md:text-5xl font-bold">loan</h1>
                        <p class="text-primary font-robot text-xl text-justify xxxs:text-base sm:text-lg lg:text-xl">We understand the importance of saving
                            for
                            the future, which is why we offer convenient and flexible savings options to help our
                            members
