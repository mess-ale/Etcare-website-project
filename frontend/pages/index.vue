<template>
    <div>
        ...
        <div class="bg-primary xxxs:py-4 md:py-8 lg:py-12">
            <div class="body-padding_margin xxxs:space-y-4 md:space-y-8">
                ...
                <p class="text-center font-robot xxxs:text-1xl sm:text-2xl md:text-3xl ">Etcare SACCO is a member-driven
                    ...
                    rooted in fostering financial literacy, economic stability, and sustainable growth for all members
                    of the
        ...
        <div class=" xxxs:py-4 md:py-8">
            <div class="body-padding_margin grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="value-boje-section p-6 shadow-md space-y-4">
                    ...
                    <p>To be Ethiopia's leading SACCO, empowering members with innovative financial solutions and
                        fostering
