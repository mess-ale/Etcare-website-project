                ...
                <div class="grid grid-cols-1 md:grid-cols-2 xxxs:gap-4 md:gap-8">
                    <div class="flex items-center">
                        <p class="text-primary font-robot text-justify xxxs:text-base md:text-xl">At Etcare SACCOs Ltd, we're known for
                            ...
                            transparency,
                            and accountability in everything we do. Our mission is to teach people about money and make
                            sure
                            everyone benefits from our services. Our values include loyalty, honesty, clear
                            communication,
                            responsibility, and helping others. We're committed to creating a strong financial future
                            for
