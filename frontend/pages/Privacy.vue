<template>
    <div class="pt-32">
        <div class="saving-p-m flex gap-4">
            <div class="saving-left">
                ...
                <ul>
                    ...
                    <li>5/Five months/ and above 15% regular savings and 10% lottery Own member gets a consumer loan,
                        the loan limit is 300,000.00 and the repayment period is up to It will be up to 30 months. </li>
                    <li>6/six months/ and above 15% regular savings and 10% interest Own member gets a consumer loan,
                        the loan limit is 400,000.00 and the repayment period is up to It will be up to 36 months.</li>
                </ul>

                <ul>
                    <h1 class="saving-title"> Business loan </h1>
                    <li>5/Five months/ and above 20% normal savings and 10% lottery Your member can get a business loan
                        with a loan limit of 500,000.00 and a repayment period of up to It will be up to 36 months.
                    </li>
                    <li>6/six months/more than 20% normal savings and 10% lottery Own member gets a business loan; the
                        loan limit is 750,000.00 and the repayment period is up to It will be up to 48 months.</li>
                    <li>12/twelve months/ more than 20% regular savings and 5% interest Own member gets a business loan
                        and the loan limit is 1,500,000.00 and the repayment period It will be up to 60 months</li>
                </ul>

                <ul>
                    <h1 class="saving-title">Loans for home purchase, construction and renovation </h1>
                    <li>20% normal savings of 6/six months/ and above in a row to borrow a home loan A member who saves
                        and buys a 10% lot gets a home loan with a loan limit of 2,000,000.00. The repayment period will
                        be up to 60 months. </li>
                    <li>8/eight months/ and above 20% regular savings and 10% interest Own member gets a home loan and
                        the loan limit is 3,000,000.00 and the repayment period is up to It will be up to 84 months.
                    </li>
                    <li>12/twelve months/ and above 18% regular savings and 7% A member who owns a lot gets a home loan
                        and the loan ceiling is 5,000,000.00 and the repayment period is It will be up to 84 months.
                    </li>
                </ul>

                <ul>
                    <h1 class="saving-title">Car loan </h1>
                    <li>20% regular savings of 6 months and more and 10% of lotteries A member gets a car loan with a
                        loan limit of 2,000,000.00 and a repayment period will be up to 48 months. </li>
                    <li>8/eight months/ and more who has saved 20% regular savings and bought 5% lottery A member gets
                        a car loan with a loan limit of up to 3,000,000.00 and the repayment period will be up to 60
                        months.</li>
                </ul>

                <ul>
                    <h1 class="saving-title">Special short-term loans </h1>
                    <li>For four months and more, he has saved 25% regular savings and bought 5% lotteries and A
                        special short-term loan for members in business with no interest at 10% commission You will get
                        it by paying only /Commission/ and the loan limit is 400,000.00 and the repayment period It will
                        last up to four months. The loan repayment period is twice a month every fifteen days </li>
                    <li>6 months continuous borrowing 20% ​​regular savings and 5% lot purchase and business Special
                        short-term loan for working members with no interest paid at 15% commission only. You will get
                        it by paying, and the loan ceiling is 600,000.00 and the repayment period will be up to 6
                        months. The loan repayment period will be twice a month every fifteen days</li>
                </ul>
                <ul>
                    <h1 class="saving-title">Salary loan </h1>
                    <li>For member of government employees, bank employees, insurance employees and hospital employees
                        15% advance savings and 5% of 6 months net salary for emergency loans Complete the lot and
                        submit a letter of guarantee from the office where you are working for a loan that will be
                    ...
                    <div class="space-y-2">
                        <div class="gap-4 p-4 border-b border-gray-200">
                            ...
                            <p class="text-primary items-center flex text-justify">
                                We offer flexible personal loans with competitive rates to help you manage life’s
                        ...
                        <div class="gap-4 p-4 border-b border-gray-200">
                            ...
                            <p class="text-primary text-justify">
                                Empower your business with fast and affordable financing options. Our business loans are
                        ...
                        <div class="gap-4 p-4 border-b border-gray-200">
                            ...
                            <p class="text-primary text-justify">
                                Make your dream home a reality. Explore our low-interest home loan options with
                        ...
                        <div class="gap-4 p-4">
                            ...
                            <p class="text-primary text-justify">
                                Invest in your future with our education loans. Whether it’s for college or vocational
