                ...
                <div v-show="userClick" class="fixed inset-0 bg-black bg-opacity-50 transition-opacity duration-300">
                    <div class="user-profile-drawer transform transition-transform duration-300">
                        <div class="bg-background">
                            ...
                            <h1 class="text-center font-bold text-3xl pb-4 font-oswald text-secondary">Hanan</h1>
                        </div>
                        <div class="head-bio flex space-x-6 p-6">
                            <h1 class="font-bold font-oswald text-lg">bio:</h1>
                            <p class="text-justify font-robot text-md text-lg ">dventurous soul with a passion for exploring the
                                unknown.
